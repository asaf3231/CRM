...
assert len(TOOL_SCHEMAS) == 8, (
    f"TOOL_SCHEMAS must contain exactly 8 schemas; found {len(TOOL_SCHEMAS)}"
)
assert len(TOOL_DISPATCH) == 8, (
    f"TOOL_DISPATCH must contain exactly 8 entries; found {len(TOOL_DISPATCH)}"
)
...
_SYSTEM_PROMPT_TEMPLATE = (
    ...
    "Your goal is to answer the user's business query using the 8 tools available to you.\n\n"
